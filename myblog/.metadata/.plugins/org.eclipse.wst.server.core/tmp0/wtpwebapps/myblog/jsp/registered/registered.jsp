...
<div>已有账号？<a href="../login/login.jsp">直接登录</a></div>
<div>不想注册？<a href="../nav/index.jsp">返回博客</a></div>
<div>忘记密码？<a href="#">联系管理员</a></div>
</div>
</form>
</div>
...
a {color:#069;}
body {margin:0; padding:0; background:#ddd;  background: url('img/registered_bg.jpg');
