                    ...
                    <div class="row">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title"><a href="back_message.jsp">留言板留言管理</a>&nbsp&nbsp&nbsp&nbsp<a href="#">日志页留言管理</a></div>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                            	<h4 style="text-align: center;">您整处于 &nbsp&nbsp<a style="color:#0000CC;">日志页</a>&nbsp&nbsp 留言管理界面</h4>
								<hr/>
                                <table class="table table-striped table-bordered" id="example">
                                    ...
                                    <%for(Reply reply: list){ %>
                                        <tr class="gradeA">
                                            ...
                                            <td><%=JournalDao.selectByID(reply.getArticleid()).getTitle()%></td>
                                            <td class="center"><%=UserDao.selectUserByID(reply.getUserid()).getUser_nick()%></td>
                                            <td class="center"><%=reply.getReplydate()%></td>
                                            <td class="center">
                                             <a href="back_reply_show.jsp?showreplyid=<%=reply.getReplyid()%>"><button class="btn btn-primary button_edit"><i class="glyphicon glyphicon-pencil glyphicon-white"></i>show</button></a>
                                            <a href="/myblog/ReplyDo?deletereplyid=<%=reply.getReplyid()%>"><button class="btn btn-danger button_delete" onclick = "return confirm('确认删除该留言记录么？')"><i class="glyphicon glyphicon-remove glyphicon-white"></i> Delete</button></td></a>
                                        </tr>
                                        <%} %>
                                    </tbody>
                                </table>
