                ...
                <div class="col-md-10">
                    ...
                    <form id="journal_release_form_id" class="journal_release_form_class" method="post" action="/myblog/EditJournalRelease">
                        ...
                        <div class="input_summary">
                            ...
                            <textarea name = "new_summary" class="input_summary_textarea" style="width: 69%;" rows="3;"><%=journal.getSummary() %></textarea><br/><br/><br/><br/><br/>
                        </div>
                        <hr/>
                        <div class="input_content">
                            <span class="input_title_label">the content of your article:</span>
                            <textarea name="new_content" class="input_content_textarea" style="width: 69%;" rows="10;"><%=journal.getContent() %> </textarea><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
                        </div>
                        <hr/>
