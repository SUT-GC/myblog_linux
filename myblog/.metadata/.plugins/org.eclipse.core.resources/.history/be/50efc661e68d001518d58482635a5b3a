                ...
                <div class="col-md-10">
                    ...
                    <form id="journal_release_form_id" class="journal_release_form_class" method="post" action="/myblog/ReleaseJournal">
                        ...
                        <div class="input_summary">
                            ...
                            <textarea name="article_summary" class="input_summary_textarea" style="width:69%;" rows="3;"></textarea><br/><br/><br/><br/><br/>
                        </div>
                        <hr/>
                        <div class="input_content">
                            <span class="input_title_label">the content of your article:</span>
                            <textarea name="article_content" class="input_content_textarea" "></textarea><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
                        </div>
                        <hr/>
